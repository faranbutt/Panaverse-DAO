        ...
        <Box _hover={{animation:animation}}>
            <Flex direction={"row"} mx='70px' px='60px' borderColor={'Window'} borderRadius='30' bgGradient='linear(to-r, green.200, pink.500)'>
                <VStack p='52px' >
                    ...
                    <Text fontFamily={"Poppins"} fontSize='1xl'>In this brand-new type of curriculum, students will learn how to make money and boost exports in the classroom and will begin doing so within six 0months of the program&apos;s beginning. It resembles a cross between a corporate venture and an educational project.</Text>
