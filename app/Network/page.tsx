...
import { SiTypescript,SiNextdotjs,SiCisco,SiAnsible} from "react-icons/si";
...
export default function Cloud(){
  return (
    <Box background={
      ...
      <Box fontFamily={'Poppins'} fontSize={'7xl'} color={'whiteAlpha.900'} padding={'20px'} display={'flex'} justifyContent={'center'} mb='10px'>Network Programmability and Automation Roadmap</Box>
      <VerticalTimeline>
  ...
  >
    ...
    <Heading className="vertical-timeline-element-subtitle">CCNA 200-301 Certification</Heading>
    <Text color={'blackAlpha.900'}>
  ...
  >
    ...
    <Heading className="vertical-timeline-element-subtitle">Network Programmability and Automation</Heading>
    <Text color={'blackAlpha.900'}>
