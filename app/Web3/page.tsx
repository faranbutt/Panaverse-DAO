...
import { SiTypescript, SiAirbnb,SiNextdotjs,SiSolidity } from "react-icons/si";
...
export default function Web3(){
  return (
    <Box background={
      ...
      <Box fontFamily={'Poppins'} fontSize={'7xl'} color={'whiteAlpha.900'} padding={'20px'} display={'flex'} justifyContent={'center'} mb='10px'>Web 3.0 Roadmap</Box>
      <VerticalTimeline>
  ...
  >
    ...
    <Heading className="vertical-timeline-element-subtitle">Developing Smart Contracts and Planet-Scale Web 3.0 Dapps</Heading>
    <Text color={'blackAlpha.900'}>
    In this course you will learn how to develop Web 3.0 DApps, create a project, deploy it in production, write smart contracts, unit test them, and create user interfaces for them. We will also learn to develop ERC-20 and NFT tokens, DAOs, Oracles, etc.
    </Text>
  </VerticalTimelineElement>
  <VerticalTimelineElement
    className="vertical-timeline-element--work"
  ...
  >
    ...
    <Heading className="vertical-timeline-element-subtitle">Developing Planet-Scale Open Virtual and Augmented Metaverse Experiences</Heading>
    <Text color={'blackAlpha.900'}>
    The Web is the Metaverse. The metaverse requires an infrastructure that connects all of the metaverses so that we can travel between them. This is only achievable with open web-based metaverses. The internet and its browsers are magical. Federated but linked experiences connect pages, people, technology, businesses, standards, and nations.
    </Text>
  </VerticalTimelineElement> 
</VerticalTimeline>
    </Box>
